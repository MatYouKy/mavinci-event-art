...
export default function EventDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'equipment' | 'team' | 'files' | 'tasks' | 'offer' | 'subcontractors' | 'logistics'
  >('overview');
        ...
        <div className="flex items-center gap-3">
          <span
            className={`rounded-lg border px-4 py-2 text-sm ${
              statusColors[event.status] || 'border-gray-500/20 bg-gray-500/10 text-gray-400'
            }`}
          >
              ...
              {equipment.map((item) => {
                ...
                return (
                  <div key={item.id}>
                          ...
                          >
                            ...
                            <div className="flex min-w-0 flex-1 flex-col">
                              ...
                              <div className="flex items-center gap-2 text-xs text-[#e5e4e2]/40">
                                {kitItem.equipment.brand && <span>{kitItem.equipment.brand}</span>}
                    ...
                    {item.notes && (
                      <div className="ml-9 mt-1 px-4 text-xs italic text-[#e5e4e2]/40">
                        {item.notes}
                      </div>
                    )}
                  </div>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-[#e5e4e2]/60">
                          ...
                          {offer.client?.company_name ||
                            `${offer.client?.first_name || ''} ${offer.client?.last_name || ''}`.trim() ||
                            'Brak klienta'}
                        </p>
                      </div>
              ...
              <input
                ...
                value={
                  formData.event_end_date
                    ? new Date(formData.event_end_date).toISOString().slice(0, 16)
                    : ''
                }
