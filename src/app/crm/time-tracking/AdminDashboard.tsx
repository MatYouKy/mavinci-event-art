...
export default function AdminDashboard() {
  ...
  const calculateStats = (entriesData: any[]) => {
    ...
    entriesData.forEach((entry) => {
      ...
      const revenue = entry.is_billable && entry.hourly_rate
        ? (duration / 60) * entry.hourly_rate
        : 0;
    ...
    setEmployeeStats(Array.from(employeeMap.values()).sort((a, b) => b.total_hours - a.total_hours));
    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#1c1f33] rounded-lg border border-[#d3bb73]/10 p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div>
            <label className="block text-sm text-[#e5e4e2]/60 mb-2">Okres</label>
        ...
        <div className="space-y-3">
          {employeeStats.map((stats) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  {stats.avatar_url ? (
                    ...
                    <div className="w-12 h-12 rounded-full bg-[#d3bb73]/20 flex items-center justify-center">
              ...
              <div className="mt-3 bg-[#1c1f33] rounded-full h-2 overflow-hidden">
                <div
      ...
      <div className="bg-[#1c1f33] rounded-lg border border-[#d3bb73]/10 p-6">
        <h3 className="text-lg font-medium text-[#e5e4e2] mb-4">Aktywność dzienna</h3>
        <div className="space-y-2">
          {dailyStats.map((stat) => (
            <div
              key={stat.date}
              className="flex items-center justify-between bg-[#0f1119] rounded-lg p-3"
            >
              <div className="flex items-center gap-4">
                <div className="text-[#e5e4e2]/60 text-sm w-24">
