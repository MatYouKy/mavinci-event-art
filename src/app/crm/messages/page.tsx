...
export default function MessagesPage() {
  ...
  const { data: messagesData, isLoading, refetch } = useGetMessagesListQuery({
                ...
                {messagesData?.hasMore && (
                  <div className="p-4 text-center">
                    <button
                      ...
                      disabled={isLoading}
                      className="px-6 py-2 bg-[#d3bb73]/20 text-[#d3bb73] rounded-lg hover:bg-[#d3bb73]/30 transition-colors disabled:opacity-50"
                    >
                      Załaduj więcej
                    </button>
                  </div>
