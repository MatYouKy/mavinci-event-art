...
import { IOfferItemDraft, IProduct } from '@/app/crm/offers/types';
...
export function useOfferWizardItemsRedux() {
  ...
  return {
    ...
    // custom form
    customItem,
    setCustomItem: (patch: Partial<typeof customItem>) => dispatch(offerWizardActions.setCustomItem(patch)),

    showCustomItemForm,
    setShowCustomItemForm: (v: boolean) => dispatch(offerWizardActions.setShowCustomItemForm(v)),

    showEquipmentSelector,
    setShowEquipmentSelector: (v: boolean) => dispatch(offerWizardActions.setShowEquipmentSelector(v)),

    showSubcontractorSelector,
    setShowSubcontractorSelector: (v: boolean) => dispatch(offerWizardActions.setShowSubcontractorSelector(v)),
