...
import { Calendar, Users, Package, FileText, CheckSquare, Mail, Settings, LayoutDashboard, Menu, X, LogOut, Building2, CircleUser as UserCircle, Ligature as FileSignature, FileType, Sparkles, Site, ChevronsLeft, ChevronsRight, GripVertical, RotateCcw, Clock, Car, BookUser, BarChart } from 'lucide-react';
...
const allNavigation: NavigationItem[] = [
  ...
  { key: 'page', name: 'Strona', href: '/crm/page', icon: Site, module: 'page' },
];
