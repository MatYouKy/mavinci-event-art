          ...
          {process.map((step) => {
            ...
            return (
              <div key={step.id} className="flex items-start gap-6">
                ...
                {!isEditing && (
                  <div className="hidden h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-[#d3bb73] md:flex">
...
const AdvantageMobileItem: FC<{
  ...
  return (
    <div className="mb-5 space-y-2 md:hidden">
      ...
      <p className="text-justify text-xs text-[#e5e4e2]/70">{description}</p>
      {duration_info && (
