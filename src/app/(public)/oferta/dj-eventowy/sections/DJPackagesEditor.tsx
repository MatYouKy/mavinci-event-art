  ...
  return (
    <section className="bg-[#0f1119] px-6 py-24">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="mb-4 text-4xl font-light text-[#e5e4e2]">Pakiety DJ</h2>
            ...
            >
              ...
              {editingId === pkg.id ? (
                <div className="space-y-4">
                  ...
                  <p className="mb-4 text-sm font-light text-[#e5e4e2]/70">{pkg.duration}</p>
                ...
                <>
                  <div className="mb-6">
                    <h3 className="mb-2 text-2xl font-light text-[#e5e4e2]">{pkg.name}</h3>
                  </div>
