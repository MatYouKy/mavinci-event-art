...
import { MapPin, Search, Speaker } from 'lucide-react';
import Footer from '@/components/Footer';
import SchemaLayout from '@/components/SchemaLayout';

export default function TechStageLokalizacjePage() {
  ...
  return (
    <SchemaLayout
      pageSlug="technika-sceniczna-lokalizacje"
      defaultTitle="Technika Sceniczna w Calej Polsce - Lokalizacje | MAVINCI"
      defaultDescription="Profesjonalna technika sceniczna w ponad 60 miastach Polski. Naglosnienie, oswietlenie, ekrany LED, sceny, rigging. Kompleksowa obsluga techniczna eventow."
      breadcrumb={[
        { name: 'Start', url: 'https://mavinci.pl/' },
        { name: 'Oferta', url: 'https://mavinci.pl/oferta' },
        { name: 'Technika sceniczna', url: 'https://mavinci.pl/oferta/technika-sceniczna' },
        { name: 'Lokalizacje', url: 'https://mavinci.pl/oferta/technika-sceniczna/lokalizacje' },
      ]}
    >
            ...
            <div className="mt-12 text-center">
              <div className="mb-6 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#d3bb73]/10">
                  <Speaker className="h-8 w-8 text-[#d3bb73]" />
                </div>
              </div>
              <h1 className="mb-6 text-4xl font-light text-[#e5e4e2] md:text-5xl">
                Technika Sceniczna <span className="text-[#d3bb73]">w Calej Polsce</span>
              </h1>
              <p className="mx-auto max-w-3xl text-xl text-[#e5e4e2]/70">
                Naglosnienie, oswietlenie, ekrany LED, sceny i rigging w ponad{' '}
                {cities.length} miastach. Wlasny sprzet, certyfikowany zespol.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div key={region}>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                      {(regionCities as any[]).map((city) => (
                        <Link
                          key={city.id}
                          href={`/oferta/technika-sceniczna/${city.locality}`}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="mt-2 text-xs text-[#d3bb73]/70">
                                Technika sceniczna w {city.locality}
                              </p>
                            </div>
                          </div>
                        </Link>
        ...
        <section className="border-t border-[#d3bb73]/20 bg-[#1c1f33]/20 px-6 py-16">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg text-[#e5e4e2]/70">
              Realizujemy technikę sceniczną w całej Polsce - skontaktuj się, a przygotujemy indywidualną ofertę
            </p>
            <Link
              href="/#kontakt"
