...
export default function TechnicalStagePackages() {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-[#0f1119] px-6 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg font-light text-[#e5e4e2]/70">
              Gotowe rozwiazania dla Twojego eventu
            </p>
          </motion.div>
                ...
                {packages
                  ...
                  .map((pkg, i) => (
                    <motion.div
                      ...
                      className="relative overflow-hidden rounded-2xl border border-[#d3bb73]/20 bg-gradient-to-br from-[#1c1f33] to-[#0f1119] p-8 shadow-2xl"
                    >
                      {pkg.icon_id ? (
                      ...
                      <h3 className="mb-3 text-2xl font-light text-[#e5e4e2]">{pkg.title}</h3>
