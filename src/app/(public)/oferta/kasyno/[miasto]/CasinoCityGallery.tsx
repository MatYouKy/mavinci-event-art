...
export default function CasinoCityGallery({ images, cityCases }: Props) {
    ...
    <section className="border-b border-[#d3bb73]/10 px-6 py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mx-auto mb-12 max-w-2xl text-center text-[#e5e4e2]/60">
          Wybrane eventy kasynowe zrealizowane przez nasz zespół
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {images.map((img, idx) => (
            ...
            >
              <Image
                src={img.image_url}
                alt={img.alt_text || `Kasyno rozrywkowe ${cityCases.locative}`}
                fill
