...
export default function WieczoryTematyczneLokalizacjePage() {
  ...
  return (
    <SchemaLayout
      pageSlug="wieczory-tematyczne-lokalizacje"
      defaultTitle="Wieczory Tematyczne w Calej Polsce - Lokalizacje | MAVINCI"
      defaultDescription="Organizacja wieczorów tematycznych w ponad 60 miastach Polski. Casino Night, Hollywood, PRL, Dziki Zachód, lata 20-te. Kompleksowa realizacja eventów firmowych."
      breadcrumb={[
        { name: 'Start', url: 'https://mavinci.pl/' },
        { name: 'Oferta', url: 'https://mavinci.pl/oferta' },
        { name: 'Wieczory Tematyczne', url: 'https://mavinci.pl/oferta/wieczory-tematyczne' },
        { name: 'Lokalizacje', url: 'https://mavinci.pl/oferta/wieczory-tematyczne/lokalizacje' },
      ]}
    >
            ...
            <div className="mt-12 text-center">
              <div className="mb-6 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#d3bb73]/10">
                  <Sparkles className="h-8 w-8 text-[#d3bb73]" />
                </div>
              </div>
              <h1 className="mb-6 text-4xl font-light text-[#e5e4e2] md:text-5xl">
                Wieczory Tematyczne <span className="text-[#d3bb73]">w Calej Polsce</span>
              </h1>
              <p className="mx-auto max-w-3xl text-xl text-[#e5e4e2]/70">
                Organizujemy niezapomniane wieczory tematyczne w ponad{' '}
                {cities.length} miastach. Casino Night, Hollywood, PRL, Western i wiele wiecej.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div key={region}>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                      {(regionCities as any[]).map((city) => (
                        <Link
                          key={city.id}
                          href={`/oferta/wieczory-tematyczne/${city.locality}`}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="mt-2 text-xs text-[#d3bb73]/70">
                                Wieczory tematyczne w {city.locality}
                              </p>
                            </div>
                          </div>
                        </Link>
        ...
        <section className="border-t border-[#d3bb73]/20 bg-[#1c1f33]/20 px-6 py-16">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg text-[#e5e4e2]/70">
              Realizujemy wieczory tematyczne w calej Polsce - skontaktuj sie, a przygotujemy indywidualna oferte
            </p>
            <Link
              href="/#kontakt"
