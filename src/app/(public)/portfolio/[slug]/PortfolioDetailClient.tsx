...
import type { PortfolioProject, GalleryImage, PortfolioProjectFeature } from '@/lib/supabase/types';
              ...
              <div>
                ...
                {isEditing && (
                  <div className="mb-6 bg-[#1c1f33]/60 border border-[#d3bb73]/20 rounded-lg p-4">
                    <label className="text-[#e5e4e2]/70 text-sm mb-2 flex items-center gap-2">
