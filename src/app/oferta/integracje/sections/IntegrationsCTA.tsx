...
export default function IntegrationsCTA({
  title = 'Zorganizuj integrację z MAVINCI',
  subtitle = 'Skontaktuj się z nami i poznaj naszą ofertę integracji firmowych. Profesjonalne eventy integracyjne, doświadczeni animatorzy, scenariusze dopasowane do Twojego zespołu.',
  ctaText = 'Zapytaj o integrację',
  secondaryText = 'lub zadzwoń: +48 123 456 789',
  features = defaultFeatures,
  onCTAClick,
}: IntegrationsCTAProps) {
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <div className="mt-12 text-center">
          <p className="text-sm font-light text-[#e5e4e2]/50">
            Obsługujemy integracje w całej Polsce • Doświadczenie od 2010 roku
          </p>
        </div>
      </div>
    </section>
