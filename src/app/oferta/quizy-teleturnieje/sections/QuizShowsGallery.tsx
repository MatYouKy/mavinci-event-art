...
interface QuizShowsGalleryProps {
  title?: string;
  subtitle?: string;
  images?: GalleryImage[];
}
...
const defaultImages: GalleryImage[] = [
  {
    ...
    title: 'Teleturniej z pilotami',
    description: 'Każdy uczestnik z bezprzewodowym pilotem do głosowania',
  },
  {
    src: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?auto=format&fit=crop&w=1200&q=80',
    title: 'Ekran z wynikami live',
    description: 'Statystyki i ranking na żywo podczas rozgrywki',
  },
  {
    src: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=1200&q=80',
    title: 'Gala firmowa z teleturniejem',
    description: 'Premium realizacja na ekskluzywnym wydarzeniu',
  },
  {
    src: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=1200&q=80',
    title: 'Konferansjer prowadzący',
    description: 'Profesjonalny prowadzący z mikrofonem i energią',
  },
  {
    src: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&w=1200&q=80',
    title: 'Buzzery i przyciski',
    description: 'System buzzerów do szybkiej rywalizacji',
  },
  {
    src: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=1200&q=80',
    title: 'Drużynowy teleturniej',
    description: 'Zespoły konkurują w quizie integracyjnym',
  },
];

export default function QuizShowsGallery({
  title = 'Zobacz nasze realizacje',
  subtitle = 'Teleturnieje na różnorodnych eventach',
  images = defaultImages,
}: QuizShowsGalleryProps) {
