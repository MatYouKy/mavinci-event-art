...
export default function UslugiPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0f1119] to-[#1c1f33] pt-32 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-500`} />

                <div className="relative z-10">
                  <div className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${service.color} border ${service.borderColor} mb-6 group-hover:scale-110 transition-transform duration-500`}>
