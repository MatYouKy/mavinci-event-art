      ...
      <main className="min-h-screen bg-[#0f1119]">
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-[#d3bb73]/30 bg-[#d3bb73]/10 px-6 py-2">
                  <Glasses className="h-5 w-5 text-[#d3bb73]" />
                  <span className="text-sm font-medium text-[#d3bb73]">Nowoczesne Technologie</span>
                </div>
                ...
                <p className="mb-8 text-lg font-light leading-relaxed text-[#e5e4e2]/70">
                  Oferujemy profesjonalne symulatory wyścigowe, lotnicze oraz gogle VR najnowszej
                  generacji. Zapewniamy niezapomniane wrażenia i emocje na Twoim evencie.
                </p>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl border border-[#d3bb73]/20 bg-gradient-to-br from-[#1c1f33]/80 to-[#1c1f33]/40 p-8 backdrop-blur-sm">
                  <Glasses className="mb-6 h-24 w-24 text-[#d3bb73]" />
                  <h3 className="mb-4 text-2xl font-light text-[#e5e4e2]">Immersja i Emocje</h3>
                  <p className="font-light text-[#e5e4e2]/70">
                    Najnowsze technologie VR i symulatory zapewniają realistyczne doznania i
                    niezapomniane przeżycia dla uczestników eventu.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-gradient-to-br from-[#0f1119] to-[#1c1f33] py-24">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <Joystick className="mx-auto mb-6 h-16 w-16 text-[#d3bb73]" />
