      ...
      <main className="min-h-screen bg-[#0f1119]">
        <section className="relative py-24 md:py-32 bg-gradient-to-br from-[#1c1f33] to-[#0f1119] overflow-hidden">
          <div className="absolute inset-0">
            <img src="https://images.pexels.com/photos/2007647/pexels-photo-2007647.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="VR headset" className="w-full h-full object-cover opacity-20" />
