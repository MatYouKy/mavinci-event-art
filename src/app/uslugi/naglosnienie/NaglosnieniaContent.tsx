            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={feature.id}
                    className="group relative flex items-start gap-3 bg-gradient-to-br from-[#1c1f33]/80 to-[#1c1f33]/40 backdrop-blur-sm border border-[#d3bb73]/10 rounded-xl p-6 hover:border-[#d3bb73]/30 transition-all duration-500 hover:scale-105 hover:shadow-lg hover:shadow-[#d3bb73]/20 animate-scale-in overflow-hidden"
                  ...
                  >
                    ...
                    <Icon className="w-5 h-5 text-[#d3bb73] flex-shrink-0 mt-0.5 relative z-10 transition-transform duration-300 group-hover:scale-110" />
