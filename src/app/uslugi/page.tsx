...
export async function generateMetadata({
  ...
  const ogImageUrl ='https://fuuljhhuhfojtmmfmskq.supabase.co/storage/v1/object/public/site-images/hero/1760341625716-d0b65e.jpg';

  return {
    title: service.seo_title || `${service.name} | MAVINCI Event & ART`,
    description: service.seo_description || 'Poznaj wszystkie nasze usługi eventowe: technika konferencyjna, nagłośnienie, oświetlenie, multimedia, streaming, sceny i atrakcje. Profesjonalna obsługa eventów',
    keywords: 'usługi eventowe, kompleksowa obsługa eventów, obsługa techniczna konferencji, nagłośnienie konferencyjne, oświetlenie eventowe, multimedia eventowe, technika sceniczna, technika estradowa, realizacja wydarzeń, realizacja konferencji',
    alternates: {
