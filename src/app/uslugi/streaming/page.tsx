...
import { Video, Wifi, Camera, MonitorPlay, CheckCircle2, ArrowLeft } from 'lucide-react';
import Link from 'next/link';
import Navbar from '@/components/Navbar';
import Footer from '@/components/Footer';

export const metadata: Metadata = {
  title: 'Streaming Eventów | Mavinci',
  description: 'Profesjonalne streamowanie eventów na żywo. Transmisje online konferencji, webinarów i wydarzeń biznesowych.',
  keywords: 'streaming, transmisja online, transmisja na żywo, streaming eventów, webinary',
};
      ...
      <main className="min-h-screen bg-[#0f1119]">
        <section className="relative py-24 md:py-32 bg-gradient-to-br from-[#1c1f33] to-[#0f1119] overflow-hidden">
          <div className="absolute inset-0">
            <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Streaming setup" className="w-full h-full object-cover opacity-20" />
