    ...
    <div className="min-h-screen bg-[#0f1119] flex items-center justify-center px-6">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <div className="relative bg-[#1c1f33] border border-[#d3bb73]/20 rounded-full p-8">
              <Package className="h-16 w-16 text-[#d3bb73]" strokeWidth={1.5} />
            </div>
          </div>
        </div>
        ...
        <h1 className="text-4xl md:text-5xl font-light text-[#e5e4e2] mb-4">
          Usługa nie została <span className="text-[#d3bb73]">znaleziona</span>
        </h1>

        {/* Description */}
        <p className="text-lg text-[#e5e4e2]/70 mb-8 max-w-lg mx-auto">
          Szukana usługa nie istnieje lub została przeniesiona. Przekierujemy Cię na listę wszystkich usług.
        </p>
        ...
        <div className="mt-12 pt-8 border-t border-[#d3bb73]/10">
          <p className="text-sm text-[#e5e4e2]/50 mb-4">Możesz być zainteresowany:</p>
          <div className="flex flex-wrap justify-center gap-2">
            {['Nagłośnienie', 'Oświetlenie', 'Multimedia', 'Streaming', 'Technika sceniczna'].map((service) => (
              <Link
                key={service}
                href="/uslugi"
