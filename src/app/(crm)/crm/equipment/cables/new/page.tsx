        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="rounded-lg border border-[#d3bb73]/20 bg-[#1c1f33] p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                <label className="mb-2 block text-sm font-medium">Ilość *</label>
                <input
                  type="number"
                  name="stock_quantity"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium">Złącze wejściowe *</label>
                <select
                  name="connector_in"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium">Złącze wyjściowe *</label>
                <select
                  name="connector_out"
