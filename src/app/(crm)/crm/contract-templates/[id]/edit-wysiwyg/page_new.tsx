  ...
  return (
    <div className="min-h-screen bg-[#0a0d1a] p-6">
      <div className="mx-auto max-w-[900px]">
        ...
        <div className="rounded-xl bg-[#2a2d3a] p-6">
          <div
          ...
          >
              ...
              >
                ...
                >
                  <img
                    ...
                    draggable={false}
                  />
                  <div className="absolute -top-8 left-0 hidden gap-2 rounded bg-black/80 px-2 py-1 group-hover:flex">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
            ...
            {selectedLogo && (
              <div className="absolute right-4 top-4 z-30 rounded-lg bg-black/90 p-3 text-white">
            ...
            {isDraggingFile && (
              <div className="absolute inset-0 z-10 flex items-center justify-center border-4 border-dashed border-[#d3bb73] bg-[#d3bb73]/20">
                <div className="text-center">
                  <Upload className="mx-auto mb-2 h-12 w-12 text-[#d3bb73]" />
                  <p className="font-medium text-[#d3bb73]">Upuść logo tutaj</p>
                </div>
              </div>
            )}
            ...
            >
              <input
                ...
                className="w-full rounded border border-gray-300 bg-white px-3 py-1 text-sm text-gray-700"
              />
            </div>
          </div>
        </div>
