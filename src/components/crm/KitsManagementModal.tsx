          ...
          {!showAddForm ? (
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-[#d3bb73]/10 pt-6" id="kit-items-list">
                <h5 className="mb-4 font-medium text-[#e5e4e2]">
                  ...
                  <div className="mb-4 space-y-3">
                    {kitItems.map((item, index) => {
                      const eq = item.equipment_id
                        ...
                        : null;
                      const cable = item.cable_id
                        ? cables.find((c) => c.id === item.cable_id)
                        : null;
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <div className="font-medium text-[#e5e4e2]">
                                ...
                                {cable && (
                                  <span className="ml-2 text-xs text-[#d3bb73]">Przewód</span>
                                )}
                              </div>
                              {eq?.brand && (
                ...
                <div className="rounded-lg border border-[#d3bb73]/10 bg-[#0f1119] p-4">
                  <div className="mb-3 flex items-center gap-2 border-b border-[#d3bb73]/10 pb-3">
                    <button
                  ...
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <input
                      ...
                      placeholder={
                        itemType === 'equipment' ? 'Szukaj sprzętu...' : 'Szukaj przewodów...'
                      }
                            ...
                            >
                              ...
                              {isAdded ? (
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 rounded-lg bg-[#d3bb73] px-3 py-1.5 text-sm font-medium text-[#1c1f33] transition-colors hover:bg-[#d3bb73]/90"
                                >
                                  <Plus className="h-4 w-4" />
                                  Dodaj
                                </button>
