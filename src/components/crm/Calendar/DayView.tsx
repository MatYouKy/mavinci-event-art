          ...
          <div className="flex">
            <div className="w-20 flex-shrink-0 border-r border-[#d3bb73]/10 bg-[#0f1119]">
              {HOURS.map((hour) => (
                <div
                  key={hour}
                  className="flex h-[80px] items-start justify-end border-b border-[#d3bb73]/5 pr-3 pt-1 text-sm text-[#e5e4e2]/40"
                >
            ...
            <div className="relative flex-1 bg-[#1c1f33]">
              {HOURS.map((hour) => (
                <div
                  key={hour}
                  className="h-[80px] cursor-pointer border-b border-[#d3bb73]/5 transition-colors hover:bg-[#d3bb73]/5"
