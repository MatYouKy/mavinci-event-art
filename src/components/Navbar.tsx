            ...
            <div className="hidden items-center gap-8 md:flex">
              ...
              <div className="relative" ref={servicesRef}>
                <button
                  ...
                  className="flex items-center gap-1 text-sm font-light text-[#e5e4e2]/90 transition-colors duration-200 hover:text-[#d3bb73]"
                >
                  Oferta
                  <ChevronDown
                    ...
                    <div className="py-2">
                      {servicesLinks.map((service) => (
                        <Link
                          ...
                          className="block px-4 py-2 text-sm text-[#e5e4e2] transition-colors hover:bg-[#d3bb73]/10"
                        >
                          {service.label}
                        </Link>
                      ))}
                  ...
                  <div className="ml-4 mt-2 space-y-2">
                    {servicesLinks.map((service) => (
                      <Link
                        ...
                        className="block touch-manipulation rounded px-3 py-3 text-xs font-light text-white/70 transition-colors active:bg-[#d3bb73]/20 active:text-white"
                      >
                        {service.label}
                      </Link>
                    ))}
