    ...
    <section className="relative h-[50vh] overflow-hidden md:h-[60vh]">
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl text-center">
          ...
          <h2 className="mb-8 animate-[fadeIn_1.2s_ease-out] text-4xl font-light leading-tight text-[#e5e4e2] sm:text-5xl md:text-6xl lg:text-7xl">
            Rozpocznijmy współpracę
          </h2>

          <p className="mx-auto mb-10 max-w-2xl animate-[fadeIn_1.4s_ease-out] text-base font-light leading-relaxed text-[#e5e4e2]/90 md:text-lg">
            Jesteśmy gotowi, aby wysłuchać Twoich pomysłów i stworzyć event, który przekroczy
            oczekiwania
          </p>
          ...
          <div className="animate-[fadeIn_1.6s_ease-out]">
            <a
              href="#contact"
              className="group inline-flex items-center gap-3 rounded-full bg-[#d3bb73] px-10 py-5 text-base font-medium text-[#1c1f33] transition-all duration-300 hover:scale-105 hover:bg-[#d3bb73]/90 hover:shadow-2xl hover:shadow-[#d3bb73]/50 md:text-lg"
            >
