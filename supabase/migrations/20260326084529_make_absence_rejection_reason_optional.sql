/*
  # Make Absence Rejection Reason Optional

  1. Changes
    - Update reject_absence function to make p_reason parameter optional
    - Allow rejection without providing a reason
*/

-- Funkcja do odrzucania nieobecności (powód opcjonalny)
...
BEGIN
  ...
  VALUES (
    ...
    v_rejector_name || ' odrzucił Twoją prośbę o ' || v_absence_type_pl || 
      ...
      CASE WHEN p_reason IS NOT NULL AND p_reason != '' THEN '. Powód: ' || p_reason ELSE '.' END,
    'absence',
    p_absence_id::text,
