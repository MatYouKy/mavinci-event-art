/*
  # Fix Calendar Timeline RPC - Remove deleted_at references

  1. Changes
    - Remove all references to e.deleted_at (events table doesn't have this column)
    - Remove v.deleted_at (vehicles table doesn't have this column)
    - Remove ei.deleted_at (equipment_items doesn't have this column)
    - Remove emp.deleted_at (employees table doesn't have this column)
    - Keep only status-based filtering
*/
