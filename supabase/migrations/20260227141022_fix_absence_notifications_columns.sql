/*
  # Fix Absence Notifications - Correct Column Names

  1. Changes
    - Use title instead of subject
    - Use related_entity_type instead of entity_type
    - Use related_entity_id instead of entity_id
*/

-- Funkcja wysyłająca notyfikację o nowej nieobecności (poprawiona kolumny)
...
-- Funkcja do zatwierdzania nieobecności (poprawiona kolumny)
...
-- Funkcja do odrzucania nieobecności (poprawiona kolumny)
