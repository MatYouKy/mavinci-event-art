/*
  # Funkcje RPC dla kalendarza wydarzeń
  
  Tworzy optymalizowane funkcje RPC które:
  - Pobierają wszystkie wydarzenia z pełnymi relacjami w 1 zapytaniu
  - Zwracają dane w formacie gotowym dla kalendarza i list
  - Minimalizują liczbę zapytań do bazy
*/

-- Funkcja dla listy wszystkich wydarzeń (kalendarz, lista)
...
GRANT EXECUTE ON FUNCTION get_events_list(timestamptz, timestamptz, text[]) TO service_role;

COMMENT ON FUNCTION get_events_list IS 
  'Pobiera listę wydarzeń z pełnymi relacjami w jednym zapytaniu dla kalendarza i list';
