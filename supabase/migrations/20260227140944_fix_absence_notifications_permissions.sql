/*
  # Fix Absence Notifications - Remove is_admin

  1. Changes
    - Remove is_admin checks (column doesn't exist)
    - Use only permissions array
*/

-- Funkcja wysyłająca notyfikację o nowej nieobecności (poprawiona)
...
-- Funkcja do zatwierdzania nieobecności (poprawiona)
...
-- Funkcja do odrzucania nieobecności (poprawiona)
