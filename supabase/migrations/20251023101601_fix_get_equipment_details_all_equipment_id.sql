/*
  # Fix get_equipment_details - use equipment_id everywhere
  
  Changes:
  - equipment_components: equipment_item_id -> equipment_id
  - equipment_images: equipment_item_id -> equipment_id
  - equipment_units: equipment_item_id -> equipment_id
*/
