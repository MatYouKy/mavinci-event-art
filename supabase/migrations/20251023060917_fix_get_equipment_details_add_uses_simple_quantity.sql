/*
  # Napraw funkcję get_equipment_details - dodaj uses_simple_quantity
  
  1. Zmiany
    - Zaktualizuj warehouse_category w get_equipment_details
    - Dodaj uses_simple_quantity do zwracanego obiektu
    - Również do warehouse_categories (lista)
  
  2. Uwagi
    - Potrzebne dla poprawnego działania UI z uproszczonym stanem
*/

CREATE OR REPLACE FUNCTION get_equipment_details(
  item_id uuid,
