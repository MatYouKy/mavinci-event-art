/*
  # Fix Contact Form to CRM Trigger
  
  Updates the trigger to use correct column names that exist in contact_messages table.
  
  Changes:
  - source -> source_page (column exists)
  - type -> category (column exists, store as 'form_submission')
  - metadata -> notes (store as JSON string in notes field)
*/
