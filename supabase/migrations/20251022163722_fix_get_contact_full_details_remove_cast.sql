/*
  # Naprawa funkcji get_contact_full_details - usuń niepotrzebny cast

  Zmienia:
  - n.created_by::uuid → n.created_by (już jest UUID)
  
  created_by w organization_notes jest już typu UUID, nie potrzeba rzutowania
*/
