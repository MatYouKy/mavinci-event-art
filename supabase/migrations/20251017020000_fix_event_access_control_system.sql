/*
  # Fix Event Access Control System - Trigger Issues

  1. Changes
    - Fix log_event_change() to handle missing employee_id
    - Make audit log work without requiring auth.uid()
    - Allow NULL employee_id for system operations
*/
...
-- Fix audit log to allow NULL employee_id
ALTER TABLE event_audit_log ALTER COLUMN employee_id DROP NOT NULL;
