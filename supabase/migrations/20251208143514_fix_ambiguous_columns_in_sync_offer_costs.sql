/*
  # Fix ambiguous columns in sync_offer_with_event_budget

  1. Problem
    - Column references are ambiguous
    - Could refer to either column or variable
...
BEGIN
  ...
  LEFT JOIN LATERAL (
    SELECT off2.id, off2.offer_number, off2.total_amount, off2.total_cost
    FROM offers off2
