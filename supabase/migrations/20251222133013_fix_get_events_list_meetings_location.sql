/*
  # Fix get_events_list - meetings location
  
  1. Problem
    - meetings table has location_id, not location
    - Function tries to use m.location which doesn't exist
  
  2. Solution
    - Use location_id and join with locations table to get name
    - For meetings without location, return empty string
*/
