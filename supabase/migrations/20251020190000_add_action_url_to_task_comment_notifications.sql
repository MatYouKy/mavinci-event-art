/*
  # Dodaj action_url do powiadomień o komentarzach w taskach

  1. Problem
    - Powiadomienia o komentarzach nie mają action_url
    - Kliknięcie nie przekierowuje do szczegółów taska

  2. Rozwiązanie
    - Dodaj action_url w formacie /crm/tasks/[id] do powiadomień o komentarzach
*/
