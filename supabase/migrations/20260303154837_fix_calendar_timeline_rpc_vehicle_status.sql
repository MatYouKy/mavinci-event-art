/*
  # Fix Calendar Timeline RPC - Use correct vehicle status

  1. Changes
    - Change vehicle status from ('available', 'in_use', 'maintenance') to 'active'
    - Vehicles use 'active' status, not the other statuses
*/
