/*
  # Naprawa funkcji dostępności - usunięcie nieistniejącego statusu

  1. Problem
    - Funkcja używała statusu 'rejected' który nie istnieje w event_status
    - Dozwolone statusy: inquiry, offer_to_send, offer_sent, offer_accepted,
      in_preparation, in_progress, completed, cancelled, invoiced

  2. Rozwiązanie
    - Usunięcie 'rejected' z warunku
    - Pozostawienie tylko 'cancelled' jako wykluczającego
*/
