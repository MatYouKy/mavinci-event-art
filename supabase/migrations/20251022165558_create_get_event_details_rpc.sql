/*
  # Funkcja RPC dla szczegółów wydarzenia
  
  Pobiera kompletne dane pojedynczego wydarzenia wraz ze wszystkimi relacjami:
  - Organizacja i kontakt
  - Kategoria z ikoną
  - Przypisani pracownicy z pełnymi danymi
  - Sprzęt
  - Pojazdy
  - Oferty
*/
...
GRANT EXECUTE ON FUNCTION get_event_details(uuid) TO service_role;

COMMENT ON FUNCTION get_event_details IS 
  'Pobiera pełne szczegóły wydarzenia wraz ze wszystkimi relacjami w jednym zapytaniu';
