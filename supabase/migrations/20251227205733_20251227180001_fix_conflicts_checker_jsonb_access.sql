/*
  # Fix conflict checker RPC function - correct JSONB access

  1. Changes
    - Fix JSONB access in loops (use direct JSONB operators instead of record population)
    - Fix availability query to handle NULL values properly
    - Improve error handling

  2. Technical Details
    - Access JSONB array elements directly: p_items->i->>'product_id'
    - Ensure proper type casting
    - Handle edge cases where data might be NULL
*/
