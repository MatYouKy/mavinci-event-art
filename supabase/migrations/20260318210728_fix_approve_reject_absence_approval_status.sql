/*
  # Fix approve_absence and reject_absence - Use approval_status Column

  Naprawia funkcje approve_absence i reject_absence aby używały:
  - employee_absences.approval_status (nie status)
*/

-- Funkcja do zatwierdzania nieobecności (poprawiona approval_status)
...
BEGIN
  ...
  -- Aktualizuj nieobecność - POPRAWKA: użyj approval_status
...
-- Funkcja do odrzucania nieobecności (poprawiona approval_status)
