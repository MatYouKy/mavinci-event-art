/*
  # Fix get_events_list - remove deleted_at check for events
  
  1. Problem
    - events table doesn't have deleted_at column
    - Function tries to filter by e.deleted_at
  
  2. Solution
    - Remove deleted_at filter for events table
    - Keep it only for meetings table
*/
