/*
  # Fix absence_type enum values in get_employee_timeline_data

  1. Changes
    - Update get_employee_timeline_data to use correct enum values
    - Enum values: vacation, sick_leave, unpaid_leave, parental_leave, training, business_trip, remote_work, other
*/
