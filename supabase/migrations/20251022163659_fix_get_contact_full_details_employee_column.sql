/*
  # Naprawa funkcji get_contact_full_details - poprawna kolumna employees

  Zmienia:
  - e.user_id → e.id (poprawna kolumna PK)
  
  Problem: employees nie ma kolumny user_id, tylko id jako PK
*/
  ...
  IF entity_type = 'organization' THEN
    result := result || jsonb_build_object(
      ...
      'notes', (
        ...
        LEFT JOIN employees e ON e.id = n.created_by::uuid
