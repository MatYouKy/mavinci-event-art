/*
  # Fix Employee Timeline Function - Correct Column Names

  1. Changes
    - Use event_date and event_end_date instead of start_date and end_date
    - Events table uses different column names than expected
*/
