/*
  # Fix get_equipment_details - use correct column names
  
  Changes:
  - Use equipment_id instead of equipment_item_id in equipment_stock
  - Use equipment_item_id correctly in other tables
*/
