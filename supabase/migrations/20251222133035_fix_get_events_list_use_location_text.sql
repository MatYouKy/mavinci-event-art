/*
  # Fix get_events_list - use location_text for meetings
  
  1. Changes
    - Use COALESCE to first try location name from locations table
    - Then fall back to location_text field
    - Finally use empty string if both are null
*/
