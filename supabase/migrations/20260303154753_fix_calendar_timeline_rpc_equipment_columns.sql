/*
  # Fix Calendar Timeline RPC - Fix equipment_items columns

  1. Changes
    - Use warehouse_category_id instead of category_id
    - Filter out deleted_at IS NOT NULL
    - Remove status check (equipment_items doesn't have status column)
*/
