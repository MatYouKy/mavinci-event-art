/*
  # Napraw trigger notyfikacji zadań

  1. Problem
    - Trigger używa kolumny 'related_id' która nie istnieje
    - Poprawna kolumna to 'related_entity_id'
    
  2. Rozwiązanie
    - Zaktualizuj funkcję notify_task_status_change()
    - Użyj 'related_entity_id' zamiast 'related_id'
    - Dodaj 'related_entity_type' = 'task'
*/
...
-- Create updated notification trigger function
