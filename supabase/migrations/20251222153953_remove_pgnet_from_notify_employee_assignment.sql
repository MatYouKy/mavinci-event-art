/*
  # Usuń próbę wysyłania maila z triggera bazodanowego
  
  Trigger będzie tylko tworzył notyfikację w systemie.
  Mail będzie wysyłany bezpośrednio z frontendu.
*/
...
'Tworzy powiadomienie przy dodaniu pracownika do wydarzenia. Mail wysyłany jest z frontendu.';
