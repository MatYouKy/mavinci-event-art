-- ============================================================================
-- SERVICE PAGES IMAGES - Tabele dla obrazów hero podstron usług
-- ============================================================================
...
CREATE POLICY "Admin write integracje_images" ON integracje_page_images FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write kasyno_images" ON kasyno_page_images FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write konferencje_images" ON konferencje_page_images FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write naglosnienie_images" ON naglosnienie_page_images FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write quizy_images" ON "quizy-teleturnieje_page_images" FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write streaming_images" ON streaming_page_images FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write vr_images" ON "symulatory-vr_page_images" FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write technika_images" ON "technika-sceniczna_page_images" FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Admin write wieczory_images" ON "wieczory-tematyczne_page_images" FOR ALL TO public USING (true) WITH CHECK (true);
